...
---Saves the state in the global _G.Devcontainers.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.Devcontainers.state")

    _G.Devcontainers.state = self
end
...
---Whether the Devcontainers is enabled or not.
---
